...
export default function UmumiyTab() {
  ...
  const churnPct =
    totalStudents > 0 ? ((inactiveStudents / totalStudents) * 100).toFixed(1) : '0.0';
  ...
  const retention =
    totalStudents > 0 ? parseFloat(((activeStudents / totalStudents) * 100).toFixed(1)) : 0;
        ...
        <div className="dash-card dash-mid-row__chart">
          ...
          {chartData.length > 0 ? (
            <ResponsiveContainer width="100%" height={280}>
              <LineChart data={chartData} margin={{ top: 16, right: 16, left: -10, bottom: 0 }}>
                ...
                <Legend wrapperStyle={{ fontSize: 12, fontFamily: 'noto-m', paddingTop: 8 }} />
                <Line
                  type="monotone"
                  dataKey="tushum"
        ...
        <div className="dash-card dash-mid-row__goals">
          ...
          <div className="dash-goals">
            ...
            <div className="dash-goal">
              ...
              <p className="dash-goal__meta">
                {t('dashboard.umumiy.goalMln', {
                  goal: GOALS.tushum_mln,
                  done: tushum_mln.toFixed(0),
                })}
              </p>
            </div>
            <div className="dash-goal">
        ...
        <div className="dash-alerts">
          ...
          <div className="dash-alert dash-alert--green">
            ...
            <div>
              ...
              <p className="dash-alert__body">
                {t('dashboard.umumiy.activeGroupsBody', {
          ...
          <div className="dash-alert dash-alert--blue">
            ...
            <div>
              ...
              <p className="dash-alert__body">
                {t('dashboard.umumiy.roomsLoadBody', {
                  rooms: totalRooms,
